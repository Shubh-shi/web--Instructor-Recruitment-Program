...
const Home = () => {
    ...
    return (
<Grid container data-aos="fade-zoom-in" sx={{px:8,mb:3}}>
<Grid lg={12} md={6} sm={6}>
    ...
    <Typography sx={{fontSize:"1.3rem",color:"#000",mb:1,fontFamily:"Inconsolata-Regular",mb:2}}>Dear Instructor,</Typography>
        <Typography sx={{fontSize:"1.3rem",color:"#000",fontFamily:"Inconsolata-Regular",display:"flex"}}>Thank you for your interest in INSAID Instructor Recruitment Program </Typography>
         
        
          </Box>
    <center><Iframe url="https://www.youtube.com/embed/q1HZj40ZQrM"
        width="687px"
        height="387px"
        id=""
        className=""
